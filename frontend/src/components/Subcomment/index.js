	...
	return (
		...
		>
			...
			>
				...
				<Box
					sx={{
						...
						maxHeight: '32px',
						top: `${
							showMoreTopPosition - commentCardTopPosition - 10
						}px`,
						backgroundColor: '#fff',
					}}
				>
			...
			>
				...
				>
					Lorem ipsum dolor sit amet consectetur. Tempus sed ut rutrum
					aliquam. Morbi tristique platea egestas posuere dignissim
					iaculis eu pellentesque. Eget condimentum enim enim enim
					commodo semper. Lacinia massa cursus elementum nec nisi
					pretium ac non. Id egestas sollicitudin leo lectus porta
					elementum libero non morbi.
					{isExpanded &&
